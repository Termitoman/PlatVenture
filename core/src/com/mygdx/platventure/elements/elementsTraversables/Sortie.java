...
public class Sortie extends ElementGraphique {

    private final PolygonShape forme;


    public Sortie(Vector2 vecteur, Texture texture) {
        super(vecteur, texture);

        //On définit la forme de la sortie par 4 points (vector2)
    ...
    protected void setUserData() {
        body.setUserData(EnumDonneesBody.SORTIE);
    }
