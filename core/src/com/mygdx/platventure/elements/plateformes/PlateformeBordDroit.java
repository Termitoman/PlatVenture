...
public class PlateformeBordDroit extends ElementGraphique {
    ...
    public PlateformeBordDroit(Vector2 vecteur, Texture texture) {
        ...
        vecteurs[3] = new Vector2(1, 0.75f/2f);
    ...
    protected void setUserData() {
        body.setUserData(EnumDonneesBody.PLATEFORME_BORD_DROIT);
    }
