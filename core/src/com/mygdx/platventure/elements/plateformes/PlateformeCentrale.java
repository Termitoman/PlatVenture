...
public class PlateformeCentrale extends ElementGraphique {
    ...
    public PlateformeCentrale(Vector2 vecteur, Texture texture) {
        ...
        //On définit la forme de la plateforme par 4 points (vector2)
    ...
    protected void setUserData() {
        body.setUserData(EnumDonneesBody.PLATEFORME_CENTRALE);
    }
